...
#include <ANN/ANN.h>
#include <dual_tree/ANNdt/ANNkd_tree_dt.h>

// Utilities
#include <util/utilities.h> // R_INFO, profiling mode, etc.
#include <util/net_sort.h> // 2, 3, and 4 size sorting networks
...
public:
  ...
  ANNkd_node* getRoot(TREE_TYPE type) { type == QUERY_TREE ? qtree->root : rtree->root; };
